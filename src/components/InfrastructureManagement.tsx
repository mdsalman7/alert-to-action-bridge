...
import { Server, Plus, Cloud, Database, Settings, Activity, Bell, Folder } from 'lucide-react';
...
const InfrastructureManagement: React.FC<InfrastructureManagementProps> = ({ user }) => {
  ...
  const handleAddMonitor = (resourceId: string, customerName: string) => {
    setSelectedCustomer({ id: resourceId, name: customerName });
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex gap-2 ml-4">
                          <Button 
                            size="sm" 
                            variant="outline"
                            onClick={() => handleAddMonitor(resource.id, resource.name)}
                          >
